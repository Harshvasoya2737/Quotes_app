...
class QuoteModel {
  ...
  factory QuoteModel.fromJson(Map<String, dynamic> json) => QuoteModel(
        ...
        bgImages: json["bg_images"] == null
            ? []
            : List<String>.from(json["bg_images"]!.map((x) => x)),
        love: json["Love"] == null
            ? []
            : List<String>.from(json["Love"]!.map((x) => x)),
        calm: json["Calm"] == null
            ? []
            : List<String>.from(json["Calm"]!.map((x) => x)),
        sad: json["Sad"] == null
            ? []
            : List<String>.from(json["Sad"]!.map((x) => x)),
        time: json["Time"] == null
            ? []
            : List<String>.from(json["Time"]!.map((x) => x)),
        future: json["Future"] == null
            ? []
            : List<String>.from(json["Future"]!.map((x) => x)),
        relationship: json["Relationship"] == null
            ? []
            : List<String>.from(json["Relationship"]!.map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "bg_images":
            bgImages == null ? [] : List<dynamic>.from(bgImages!.map((x) => x)),
        ...
        "Future":
            future == null ? [] : List<dynamic>.from(future!.map((x) => x)),
        "Relationship": relationship == null
            ? []
            : List<dynamic>.from(relationship!.map((x) => x)),
      };
}
